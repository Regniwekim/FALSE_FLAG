...
- UI typography uses Special Gothic Expanded One for title text and Share Tech Mono for body text via Google Fonts. Special Gothic Expanded One is Copyright 2023 The Special Gothic Project Authors. Share Tech Mono is Copyright (c) 2012 Carrois Type Design and Ralph du Carrois. Both fonts are licensed under SIL Open Font License 1.1. Sources: https://fonts.google.com/specimen/Special+Gothic+Expanded+One and https://fonts.google.com/specimen/Share+Tech+Mono Licenses: https://fonts.google.com/specimen/Special+Gothic+Expanded+One/license and https://fonts.google.com/specimen/Share+Tech+Mono/license